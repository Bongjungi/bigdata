...
public class ExAccount {
	...
	private int balance;
	public ExAccount(String accountNo, String ownerName, int balance) { //오른쪽 마우스 > source > generate constructor using field
	...
	public ExAccount() {}; //오른쪽 마우스 > source> generate constructor using superclass
